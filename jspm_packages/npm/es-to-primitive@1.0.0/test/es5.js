...
test('Objects', function(t) {
  ...
  t.throws(function() {
    return toPrimitive(uncoercibleObject);
  }, TypeError, 'uncoercibleObject throws a TypeError');
  t.throws(function() {
    return toPrimitive(uncoercibleObject, String);
  }, TypeError, 'uncoercibleObject with hint String throws a TypeError');
  t.throws(function() {
    return toPrimitive(uncoercibleObject, Number);
  }, TypeError, 'uncoercibleObject with hint Number throws a TypeError');
  t.throws(function() {
    return toPrimitive(uncoercibleFnObject);
  }, TypeError, 'uncoercibleFnObject throws a TypeError');
  t.throws(function() {
    return toPrimitive(uncoercibleFnObject, String);
  }, TypeError, 'uncoercibleFnObject with hint String throws a TypeError');
  t.throws(function() {
    return toPrimitive(uncoercibleFnObject, Number);
  }, TypeError, 'uncoercibleFnObject with hint Number throws a TypeError');
  t.end();
});
